          ...
          <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 py-12 md:grid-cols-2">
            <ContainerStagger>
              ...
              <ContainerAnimated className="font-gotham-condensed font-bold uppercase leading-[0.9] tracking-tight text-white" style={{ fontSize: '81px', lineHeight: '81px', fontWeight: 700 }}>
                State-of-the-Art Gym Training
              </ContainerAnimated>
              <ContainerAnimated className="my-4 font-gotham text-white max-w-lg" style={{ fontWeight: 500, fontSize: '13px', lineHeight: '19px' }}>
                Access world-class equipment and facilities for all your training needs. 
                From cardio to strength training, we have everything you need to reach 
                your fitness goals with dedicated training zones for every fitness level.
              </ContainerAnimated>
              <ContainerAnimated>
              ...
              {GYM_IMAGES.map((imageUrl, index) => (
                <GalleryGridCell index={index} key={index}>
                  <Image
                    ...
                    src={imageUrl}
                    alt={`Gym training facility ${index + 1}`}
                    fill
