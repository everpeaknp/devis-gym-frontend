          ...
          <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-8 px-8 py-12 md:grid-cols-2">
            <ContainerStagger>
              ...
              <ContainerAnimated className="my-4 font-gotham text-white max-w-lg" style={{ fontWeight: 500, fontSize: '13px', lineHeight: '19px' }}>
                Build strength, power, and muscle with proper technique and progressive 
                training. Our professional weightlifting programs include Olympic lifting, 
                powerlifting, and strength training with certified coaches.
              </ContainerAnimated>
              <ContainerAnimated>
            ...
            <GalleryGrid>
              {WEIGHTLIFTING_IMAGES.map((imageUrl, index) => (
                <GalleryGridCell index={index} key={index}>
                  <Image
                    className="size-full object-cover object-center"
                    src={imageUrl}
                    alt={`Weightlifting training ${index + 1}`}
                    fill
