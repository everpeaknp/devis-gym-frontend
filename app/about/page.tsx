...
const AboutContent = () => {
  return (
    <div className="bg-background">
      ...
      <section className="w-screen relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] bg-background-elevated">
        <div className="container-edge py-16 md:py-20">
          <Reveal>
        ...
        <div className="flex w-full">
          ...
          <div className="bg-[#d4ff00] flex flex-col items-center justify-center py-8 px-4 min-w-[60px] flex-shrink-0 z-10">
            ...
            >
              ...
              <span className="text-black font-bold text-xs tracking-wide" style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}>
                @devisgym_pokhara
              </span>
            </a>
          </div>
